...
public class AppData {
    ...
    public final Boolean createCustomer(String firstName, String lastName, String address, String email, int password){

           currentCustomer = CustomerRepository.createCustomer(firstName, lastName, address, email, password);
    ...
    public final boolean loginCustomer(int customerID, int password){
    	...
    	try {
    		currentCustomer = CustomerRepository.loginCustomer(customerID, password);
            return currentCustomer != null;
    	}catch (Exception err) {
